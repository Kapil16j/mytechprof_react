...
import ContactImg from "../../assets/img/contactus/contact.jpg"
import { CompanyPhone } from "../common/base";
...
const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappLink = `https://wa.me/+91${CompanyPhone}?text=${encodeURIComponent(
      whatsappMessage
    )}`;
  ...
  return (
    <>
      ...
      <div className="flex flex-row ">
        ...
        <div>
          <div>
            <img src={ContactImg} className="w-fit"></img>
          </div>
        </div>
      </div>
    </>
